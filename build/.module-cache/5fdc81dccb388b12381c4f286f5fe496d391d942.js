	...
	render:function(){
		return (
				React.createElement("form", null, 
					...
					React.createElement(SelectComponent, {selectEvent: this.selectEvent, ref: "selectP", keyword: "hey"}), 
...
var SelectComponent = React.createClass({displayName: "SelectComponent",
	...
	render:function(){
		return (
			React.createElement("select", {defaultValue: "前端工程师", onChange: this.props.selectEvent, ref: "selectp"}, 
