var Form = React.createClass({displayName: "Form",
	...
	submitEvent:function(e){
		e.preventDefault();
		console.log(this.refs.profession)
	    var data ={
	...
	render:function(){
		return (
				React.createElement("form", null, 
					...
					React.createElement(SelectComponent, {onSelect: this.selectEvent, ref: "profession"}), 
...
var SelectComponent = React.createClass({displayName: "SelectComponent",
	render:function(){
		return (
			React.createElement("select", {onClick: this.props.selectEvent, value: "1"}, 
